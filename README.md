...
I build data and AI systems that turn messy information into usable analysis, dashboards, predictions, and decision support. My current work spans data quality, analytics engineering, machine learning, API-driven applications, and AI-assisted products.
...
### [Diabetes Prediction — EDA & Machine Learning](https://github.com/stanleymay20/diabetes_prediction)
End-to-end analytical notebook covering preprocessing, exploratory analysis and supervised machine learning.

**Evidence:** Python, Jupyter, Pandas, exploratory data analysis, feature preprocessing, Random Forest classification and model evaluation.

## Current focus

- Python and SQL for analytical workflows
- Data quality, transformation and reproducible analysis
...
Currently pursuing postgraduate study alongside applied data and AI projects.
